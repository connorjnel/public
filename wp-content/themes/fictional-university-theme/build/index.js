(window.webpackJsonp_fictional_university_theme = window.webpackJsonp_fictional_university_theme || []).push([[1], [function (t, e, n) {}]]),
	(function (t) {
		function e(e) {
		...
		function (t, e, n) {
					...
					return (
						u(t, [
							...
							},
							{
								key: 'emit',
								value: function (t, e) {
									if (m(t)) for (var n = 0; n < t.length; n++) this.emit(t[n], e);
				...
				var a = function () {
					...
					c = function () {
						...
						return (
							(r = this),
							(o = arguments),
							l <= 0 || l > e ? (i && (clearTimeout(i), (i = null)), (u = c), (s = t.apply(r, o)), i || (r = o = null)) : i || !1 === n.trailing || (i = setTimeout(a, l)),
							s
						);
					};
				return (
			...
			var H = { ltr: ['marginLeft', 'marginRight'], rtl: ['marginRight', 'marginLeft'] };
			function T(t) {
				if (t && t.parentNode) {
								...
								t.disabled ||
									...
									e.Transition.after(function () {
										r.isStart() && n.emit('run.start', r.move),
											...
											(r.isOffset('<') || r.isOffset('>')) && ((r._o = !1), n.emit('run.offset', r.move)),
								...
								switch (o) {
									case '>':
										'>' === i
											? (t.index = n)
											: this.isEnd()
											? (t.isType('slider') && !t.settings.rewind) || ((this._o = !0), (t.index = 0))
											: s
							...
							c = {
								...
								move: function (i) {
									...
									if (!t.disabled) {
										...
										this.enable(),
											c > a && l < s.touchAngle
												? (s.perTouch && (d = Math.min(d, f(s.perTouch))), e.Direction.is('rtl') && (d = -d), e.Run.make(e.Direction.resolve('<' + d)))
												: c < -a && l < s.touchAngle
												? (s.perTouch && (d = Math.max(d, -f(s.perTouch))), e.Direction.is('rtl') && (d = -d), e.Run.make(e.Direction.resolve('>' + d)))
												: e.Move.make(),
				...
				new (class {
					constructor() {
						if (document.querySelector('.hero-slider')) {
							...
							document.querySelector('.glide__bullets').insertAdjacentHTML('beforeend', e), new V('.hero-slider', { type: 'carousel', perView: 1, autoplay: 3e3 }).mount();
						}
					}
				})();
		},
